...
def run_apply_cycle() -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {'started_at': started, 'vercel': _is_vercel(), 'platforms': {'naukri': enable_naukri, 'linkedin': enable_linkedin}, 'excel_file': excel_file, 'naukri': None, 'linkedin': None, 'errors': [], 'finished_at': None, 'excel_blob_url': None}
